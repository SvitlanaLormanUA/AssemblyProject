...
nextStep:
    ...
    mov  sortedCount, 8             ; Since we are sorting 8 keys (16 bytes / 2 bytes per key)

    ; Now output the sorted keys
    mov si, 0
    mov  si, offset keyBuffer       ; Set SI to the beginning of the sorted keys buffer
